                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('jenis_kamar_id') is-invalid @enderror" id="jenis_kamar_id" name="jenis_kamar_id" required>
                            ...
                            @foreach($jenisKamars as $jenis)
                                <option value="{{ $jenis->id }}" {{ old('jenis_kamar_id') == $jenis->id ? 'selected' : '' }}>{{ $jenis->nama_jenis }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="tersedia" value="tersedia" {{ old('status', 'tersedia') == 'tersedia' ? 'checked' : '' }}>
                                <label class="form-check-label" for="tersedia">Tersedia</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="dipesan" value="dipesan" {{ old('status') == 'dipesan' ? 'checked' : '' }}>
